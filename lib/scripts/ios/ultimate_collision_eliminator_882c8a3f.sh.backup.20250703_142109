...
# 💥 Bundle ID: ${BUNDLE_ID:-com.insurancegroupmo.insurancegroupmo}

set -euo pipefail

# 🔧 Configuration
SCRIPT_DIR="$(dirname "$0")"
MAIN_BUNDLE_ID="${1:-${BUNDLE_ID:-com.insurancegroupmo.insurancegroupmo}}"
...
post_install do |installer|
  ...
  puts "💥 Bundle ID: ${BUNDLE_ID:-com.insurancegroupmo.insurancegroupmo}"
  puts ""
