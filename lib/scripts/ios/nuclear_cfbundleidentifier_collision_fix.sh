...
display_nuclear_fix_summary() {
    ...
    log_info "   - Main App: ${BUNDLE_ID:-com.insurancegroupmo.insurancegroupmo}"
    log_info "   - Tests: ${BUNDLE_ID:-com.insurancegroupmo.insurancegroupmo}.tests"
    log_info "   - Frameworks: ${BUNDLE_ID:-com.insurancegroupmo.insurancegroupmo}.nuclear.framework.{name}"
    log_info ""
