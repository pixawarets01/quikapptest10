...
MAIN_BUNDLE_ID="${BUNDLE_ID:-${APP_ID:-${BUNDLE_ID:-com.twinklub.twinklub}}}"
...
echo "   ${BUNDLE_ID:-com.twinklub.twinklub}.rt.connectivity_plus → ${BUNDLE_ID:-com.twinklub.twinklub}.rt.connectivityplus"
echo "" 