...
analyze_bundle_identifiers() {
    ...
    if [ -f "$PROJECT_FILE" ]; then
        ...
        local main_bundle_count=$(grep -c "${BUNDLE_ID:-com.twinklub.twinklub}" "$PROJECT_FILE" || echo "0")
        echo "   Found $main_bundle_count occurrences of '${BUNDLE_ID:-com.twinklub.twinklub}'"
    ...
    target.build_configurations.each do |config|
      ...
      if current_bundle_id
        ...
        if current_bundle_id == main_bundle_id || 
           current_bundle_id.include?('${BUNDLE_ID:-com.twinklub.twinklub}') || 
...
- Main app bundle ID preserved: ${BUNDLE_ID:-com.twinklub.twinklub}
- Pod targets use pattern: ${BUNDLE_ID:-com.twinklub.twinklub}.pod.{targetname}
...
main() {
    ...
    echo "    Main app: ${BUNDLE_ID:-com.twinklub.twinklub}"
    echo "    Pod targets: ${BUNDLE_ID:-com.twinklub.twinklub}.pod.{targetname}"
